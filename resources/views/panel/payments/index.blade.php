            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered dataTable dtr-inline text-center">
                    ...
                    @foreach($payments as $key => $payment)
                        <tr>
                            <td>{{ ++$key }}</td>
                                <td>@if($payment->types == 0){{ $payment->order->user->name }}@elseif($payment->types == 1){{ $payment->wallets->users->name }}@endif</td>
                                <td>@if($payment->types == 0){{ $payment->order->user->family }}@elseif($payment->types == 1){{ $payment->wallets->users->family }}@endif</td>
