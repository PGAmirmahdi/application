            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered dataTable dtr-inline text-center">
                    ...
                    @foreach($payments as $key => $payment)
                        <tr>
                            <td>{{ ++$key }}</td>
                                <td>@if($payment->types == false){{ $payment->order->users->name }}@elseif($payment->types == true){{ $payment->wallets->users->name }}@endif</td>
                                <td>@if($payment->types == false){{ $payment->order->users->family }}@elseif($payment->types == true){{ $payment->wallets->users->family }}@endif</td>
