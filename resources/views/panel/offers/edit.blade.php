            ...
            <form action="{{ route('offers.update', $offer->id) }}" method="post" id="offer-form">
                ...
                <div class="form-row">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 mb-3">
                        ...
                        <input type="number" name="price_before" class="form-control" id="price_before" value="{{ old('price_before', $offer->price_before) }}" readonly>
                        @error('price_before')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-3 mb-3">
                        ...
                        <input type="number" name="price_after" class="form-control" id="price_after" value="{{ old('price_after', $offer->price_after) }}" readonly>
                        @error('price_after')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
