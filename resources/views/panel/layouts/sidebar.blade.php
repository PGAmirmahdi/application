...
<div class="navigation">
    <div class="navigation-icon-menu" style="overflow-y: auto">
        <ul>
            <li class="{{ active_sidebar(['panel','users','users/create','users/{user}/edit','wallet','wallet/create','wallet/{wallet}/edit','charging','charging/create','wallet.search']) ? 'active' : '' }}" data-toggle="tooltip" title="داشبورد">
    ...
    <div class="navigation-menu-body">
        <ul id="navigationDashboards" class="{{ active_sidebar(['panel','users','users/create','users/{user}/edit','wallet','wallet/create','wallet/{wallet}/edit','wallet.search','charging','charging/create']) ? 'navigation-active' : '' }}">
            ...
            <li>
                <a class="{{ active_sidebar(['wallet','wallet/create','wallet.search','wallet/{wallet}/edit']) ? 'active' : '' }}" href="{{ route('wallet.index') }}">کیف پول</a>
            </li>
            <li>
