            ...
            <form action="{{ route('updates.update', $update->id) }}" method="post">
                ...
                <div class="form-row">
                    <div class="col-xl-3 col-lg-3 col-md-3 mb-3">
                        ...
                        <input type="text" name="version" class="form-control" id="version" value="{{ $update->version }}" placeholder="1.0.0">
                        @error('version')
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 mb-3">
                        ...
                        <input type="text" name="title" class="form-control" id="title" value="{{ $update->title }}" placeholder="قابلیت جستجوی کارتریج پرینتر">
                        @error('title')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-3 mb-3">
                        <div class="custom-control custom-checkbox mt-4 text-center">
                            <input type="checkbox" name="required" id="required" class="custom-control-input" {{ $update->required ? 'checked' : '' }}>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <textarea id="editor-demo2" name="description">{!! $update->description !!}</textarea>
                        @error('description')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
